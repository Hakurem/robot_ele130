...
from Main import Configs, d, MathCalculations, lagPlot, sendInputs
...
def main():
    ...
    _thread.start_new_thread(sendInputs, (inputSock,)) 
...
def SetupInputSocket():
    ...
    try:
        ...
        signalData = sock.recv(1024)
        if signalData == b"ack":
            print("Connection established for inputs")
        else:
            print("no ack")
            sys.exit()
    except socket.timeout:
