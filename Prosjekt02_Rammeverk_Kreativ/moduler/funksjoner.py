...
# Bruker ikke json decode på roboten fordi det tar for lang tid
# lager data som skal sendes til roboten
# som vi kan manipulere og dermed få lavere tidsskritt
