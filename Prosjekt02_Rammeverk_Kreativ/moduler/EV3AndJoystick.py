...
# Set up socket for movement inputs
def InputSocket(robot):
    ...
    robot.inputConnection = connection
...
def Initialize(Configs):
    ...
    if Configs.livePlot:
        ...
        ev3.speaker.play_notes(['C3/4'])
        ev3.speaker.set_volume(50, which='Beep')
        ...
        if Configs.controlRobot:
            while not ("inputConnection" in robot.__dict__ and "connection" in robot.__dict__):
                pass
